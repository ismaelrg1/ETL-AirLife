...
def verify_data():
    ...
    try:
        ...
        sample_airports = pd.read_sql(
                              "SELECT name, city, country, iata_code FROM airports LIMIT 3",
                              engine
                          )
...
some interesting queries on the loaded data
